...
class DatabaseSeeder extends Seeder
{
	...
	public function run(): void
	{
		...
		$attestaion = User::factory(1)->create(["name" => "Paterne MOUNDZIEGOU", "full_name" => "Paterne MOUNDZIEGOU", "profile" => "create_attestation", "password" => "P@sse123", "password_change_required" => false, "activated" => true, "email" => "paterne.moundziegou@cofinacorp.com"])->first();
		...
		$typeOfCredit = TypeOfCredit::factory(1)->create(["name" => "AVANCE SUR FACTURE","full_name" => "avance sur facture", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $moral_person->id])->first();
		TypeOfCredit::factory(1)->create(["name" => "AVANCE SUR FACTURE","full_name" => "avance sur facture", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $moral_person->id]);
		...
		TypeOfCredit::factory(1)->create(["name" => "CREDIT D'INVESTISSEMENT","full_name" => "investissement", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT D'INVESTISSEMENT","full_name" => "investissement", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  CONSO","full_name" => "consommation", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  CONSO","full_name" => "consommation", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $physical_person->id]);
		...
		TypeOfCredit::factory(1)->create(["name" => "CREDIT FDR","full_name" => "fonds de roulement", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $moral_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT FDR", "full_name" => "fonds de roulement", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $moral_person->id]);
		...
		TypeOfCredit::factory(1)->create(["name" => "CREDIT D'INVESTISSEMENT","full_name" => "investissement", "min_month" => 12, "max_month" => 24, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT D'INVESTISSEMENT","full_name" => "investissement", "min_month" => 24, "max_month" => 36, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  CONSO","full_name" => "consommation", "min_month" => 12, "max_month" => 24, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  CONSO","full_name" => "consommation", "min_month" => 24, "max_month" => 36, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT FDR", "full_name" => "fonds de roulement", "min_month" => 12, "max_month" => 24, "type_of_applicant_id" => $moral_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT IMMOBILIER", "full_name" => "immobilier", "min_month" => 24, "max_month" => 36, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT D'INVESTISSEMENT", "full_name" => "investissement", "min_month" => 36, "max_month" => 120, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  CONSO","full_name" => "consommation", "min_month" => 36, "max_month" => 120, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  BFR", "full_name" => "fonds de roulement","min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT  BFR", "full_name" => "fonds de roulement","min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $physical_person->id]);
		...
		TypeOfCredit::factory(1)->create(["name" => "PP COMMERCANT","full_name" => "pp commerçant", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "PP COMMERCANT","full_name" => "pp commerçant", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT CONSO/IMMO","full_name" => "conso/immo", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT CONSO/IMMO","full_name" => "conso/immo", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT CONSO/IMMO","full_name" => "conso/immo", "min_month" => 12, "max_month" => 24, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT CONSO/IMMO","full_name" => "conso/immo", "min_month" => 24, "max_month" => 36, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT SPOT","full_name" => "spot", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT SPOT","full_name" => "spot", "min_month" => 6, "max_month" => 12, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT SPOT","full_name" => "spot", "min_month" => 12, "max_month" => 24, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "CREDIT SPOT","full_name" => "spot", "min_month" => 24, "max_month" => 36, "type_of_applicant_id" => $physical_person->id]);
		TypeOfCredit::factory(1)->create(["name" => "AVANCE SUR SALAIRE","full_name" => "avance sur salaire", "min_month" => 0, "max_month" => 6, "type_of_applicant_id" => $physical_person->id]);

		foreach (["Dépôt de garantie", "Caution solidaire et personnelle", "Gage de véhicule", "Gage de materiel professionnel","Un engagement de domiciliation de recette", "Engagement de domiciliation de paiement","Domiciliation de bon de commande","Domiciliation irrévocable du marché","Domiciliation irrévocable du bon de commande","Domiciliation irrevocable de facture", "Domiciliation irrévocable de contrat","Domiciliation et nantissement des loyers","FDG","Constitution de PEP", "Constitution de dépôt hebdomadaire", "Hypothèque", "Nantissement de compte bancaire","Domiciliation irrévocable de salaire","Domiciliation partielle de salaire","Transfert fiduciaire","Cession de salaire","PAH","Nantissement de bon de commande","Domiciliation et nantissement de factures","Domiciliation et nantissement du materiel d'exploitation"] as $typeOfGuaranteeName) {
