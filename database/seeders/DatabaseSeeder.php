...
class DatabaseSeeder extends Seeder
{
	...
	public function run(): void
	{
		...
		foreach (["Dépôt de garantie", "Caution solidaire et personnelle", "Gage de véhicule", "Gage de materiel professionnel","Un engagement de domiciliation de recette", "Engagement de domiciliation de paiement","Domiciliation de bon de commande","Domiciliation irrévocable du marché","Domiciliation irrévocable du bon de commande","Domiciliation irrevocable de facture", "Domiciliation irrévocable de contrat","Domiciliation et nantissement des loyers","FDG","Constitution de PEP", "Constitution de dépôt hebdomadaire", "Hypothèque", "Nantissement de compte bancaire","Domiciliation irrévocable de salaire","Domiciliation partielle de salaire","Transfert fiduciaire","Session de salaire","PAH","Domiciliation et nantissement de bon de commande"] as $typeOfGuaranteeName) {
