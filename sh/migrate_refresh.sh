...
#Suppresion de l'utilisateur et de son schema
sqlplus -S system/welcome123@localhost:1521/xe @./user_deletion.sql;
#Nouvel création de l'utilisateur et de son schema
