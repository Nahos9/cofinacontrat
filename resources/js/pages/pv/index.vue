        ...
        <template #item.actions="{ item }">
            ...
            <IconBtn
              ...
              @click="
                ...
                (actionTitle = 'Supprimer le PV'),
                  (actionText = 'Voulez vous vraiment supprimer ce pv?'),
          ...
          >
            ...
            <span :class="item.status == 'validated' ? 'full-width-icon' : ''">
              <IconBtn
                v-if="$can('reject', 'pv') && item.status != 'rejected'"
                @click="
                  selectedItemId = item.id;
                  (actionTitle = 'Rejeter le PV'),
                    (actionText = 'Voulez vous vraiment rejeter ce PV?'),
              ...
              <IconBtn
                ...
                @click="
                  ...
                  (actionTitle = 'Valider le PV'),
                    (actionText = 'Voulez vous vraiment valider ce PV?'),
                    (actionFunction = apiChangeStatus);
