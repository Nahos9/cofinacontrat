...
const { data: guarantorData, execute: fetchGuarantors } = await useApi(
  createUrl("/guarantor", {
    query: {
      search: searchQuery,
      with_verbal_trial: 1,
...
const { data: contractData } = await useApi(
  createUrl(`/contract/${route.params.contract_id}`)
);
      ...
      <div class="d-flex flex-wrap gap-4 mx-5">
        ...
        <div class="d-flex gap-4 flex-wrap align-center">
          ...
          <VBtn
            ...
            :to="{
              name: 'contract-contract_id-guarantor-add',
        ...
        <template #item.actions="{ item }">
          <IconBtn
            ...
            :to="{
              ...
              params: { contract_id: route.params.contract_id, id: item.id },
            }"
          >
            <VTooltip
              activator="parent"
          ...
          <IconBtn
            ...
            :to="{
              name: 'contract-contract_id-guarantor-edit-id',
              params: { contract_id: route.params.contract_id, id: item.id },
            }"
          >
            <VTooltip
                ...
                <div v-if="$can('download', 'guarantor')">
                  ...
                  <VListItem
                    @click="
                      ...
                      downloadFile(
                        `/api/guarantor/download/${item.id}`,
                        `Contrat-Caution-${item.contract.verbal_trial.committee_id}.docx`
                      );
                    "
                  >
                    <template #prepend>
                  ...
                  <VListItem
                    @click="
                      downloadFile(
                        `/api/guarantor/promissory-note/download/${item.id}`,
                        `Billet-à-ordre-Caution-${item.contract.verbal_trial.committee_id}.docx`
                      )
                    "
                  >
                    <template #prepend>
