...
CREATE TABLE `c_a_t_s` (
  ...
  `source_of_reimbursement` enum('revenue_from_the_activity','final_payer_settlement','resale_of_goods') COLLATE utf8mb4_unicode_ci NOT NULL,
  `instructions_from_the_risk_and_credit_department` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `outstanding_number_ready_to_settle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `other_expenses` decimal(30,3) NOT NULL,
  `teg` decimal(30,3) NOT NULL,
  `validator_user_id` bigint unsigned DEFAULT NULL,
  `validation_status` enum('waiting','rejected','validated') COLLATE utf8mb4_unicode_ci NOT NULL,
  `validation_comment` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unblocker_user_id` bigint unsigned DEFAULT NULL,
  `unblock_status` enum('waiting','rejected','validated') COLLATE utf8mb4_unicode_ci NOT NULL,
  `unblock_comment` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `companies` (
  ...
  `rccm_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `contracts` (
  ...
  `representative_birth_place` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative_nationality` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative_home_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative_phone_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative_type_of_identity_document` enum('cni','passport','residence_certificate','driving_licence') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cni',
  `representative_number_of_identity_document` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `type` enum('particular','company','individual_business') COLLATE utf8mb4_unicode_ci NOT NULL,
  `has_pledges` tinyint(1) NOT NULL DEFAULT '0',
  `creator_id` bigint unsigned NOT NULL,
  `signed_contract_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signed_promissory_note_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('waiting','rejected','validated') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting',
  `status_observation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `deadline_postponeds` (
  ...
  `status` enum('waiting_ca','rejected_by_ca','waiting_dex','rejected_by_dex','waiting_head','rejected_by_head','waiting_md','rejected_by_md','waiting_credit_admin','rejected_by_credit_admin','waiting_report','reported') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting_ca',
  `comment` text COLLATE utf8mb4_unicode_ci,
  `extension` int NOT NULL,
  `beneficiary_label` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `loan_amount` decimal(21,2) NOT NULL,
  `representative_civility` enum('Mr','Mme','Mlle') COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative_last_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative_first_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `guarantors` (
  ...
  `contract_id` bigint unsigned DEFAULT NULL,
  `notification_id` bigint unsigned DEFAULT NULL,
  `civility` enum('Mr','Mme','Mlle') COLLATE utf8mb4_unicode_ci NOT NULL,
  `first_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `last_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `home_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_of_identity_document` enum('cni','passport','residence_certificate','driving_licence') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cni',
  `number_of_identity_document` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `individual_businesses` (
  ...
  `contract_id` bigint unsigned NOT NULL,
  `denomination` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `corporate_purpose` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `head_office_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rccm_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `notifications` (
  ...
  `number_of_due_dates` int NOT NULL,
  `risk_premium_percentage` double(8,2) NOT NULL,
  `head_credit_validation` enum('waiting','rejected','validated') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting',
  `head_credit_observation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('waiting','rejected','validated') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting',
  `status_observation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_amount_of_interest` decimal(30,10) NOT NULL,
  `representative_type_of_identity_document` enum('cni','passport','residence_certificate','driving_licence') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cni',
  ...
  `representative_date_of_issue_of_identity_document` date NOT NULL,
  `type` enum('particular','company','individual_business') COLLATE utf8mb4_unicode_ci NOT NULL,
  `business_denomination` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signed_notification_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signed_contract_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signed_promissory_note_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `creator_id` bigint unsigned NOT NULL,
...
CREATE TABLE `pledges` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `contract_id` bigint unsigned NOT NULL,
  `type` enum('vehicle','stock') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  
55bGSSDbg3sq.',NULL,1,0,'9uIs0ZL6Xb','2024-05-06 09:36:21','2024-05-06 09:36:21'),(37,'amah.ayikoe','amah.ayikoe@cofinacorp.com','Amah AYIKOE','caf','2024-05-06 09:36:21','$2y$12$pfNPRiObaNwlyM7HlEJMO.XJ0c4GpBYwA1sQeIiyA8YXoeHu6jOui',NULL,1,0,'NG5zALpNEC','2024-05-06 09:36:22','2024-05-06 09:36:22'),(38,'aime.hounsou-degbe','aime.hounsou-degbe@cofinacorp.com','Aimé Edem HOUNSOU DEGBE','caf','2024-05-06 09:36:22','$2y$12$ZB3PFgcXjKYql7fWAMxt6.gQzoKXr.yGLZ7XES/3U4foOJVT1XVFm',NULL,1,0,'lQau8UiFNz','2024-05-06 09:36:22','2024-05-06 09:36:22'),(39,'abra.dougame','abra.dougame@cofinacorp.com','Abra DOUGAME','caf','2024-05-06 09:36:22','$2y$12$.wTXEfEBzw3d.pIJqVLhiOAWP5oIccpSS65njiC2OW47Qj6BD8kEW',NULL,1,0,'8zTgqymhRV','2024-05-06 09:36:23','2024-05-06 09:36:23'),(40,'samuel.akakpo','samuel.akakpo@cofinacorp.com','Ablam Samuel AKAKPO','caf','2024-05-06 09:36:23','$2y$12$9H0OFnjpZUPhnTkhQzRw4e40F0LqBaVlItCC0A0KgamxTACELwY2i',NULL,1,0,'SOOSemCKuc','2024-05-06 09:36:23','2024-05-06 09:36:23'),(41,'abire.kpenifei','abire.kpenifei@cofinacorp.com','Abire KPENIFEI KPATCHA','caf','2024-05-06 09:36:23','$2y$12$v0Cf0aOSAZER3tF/mZUVreASL0p43E/Lbe3EiTmBGBZG8tgMIJBIG',NULL,1,0,'6TFjYxMAo9','2024-05-06 09:36:24','2024-05-06 09:36:24'),(42,'kabirou.yomenou','kabirou.yomenou@cofinacorp.com','Abdou Kabirou YOMENOU','caf','2024-05-06 09:36:24','$2y$12$5zDmmVpltE7UbxC729cz7O2cP7yFFvMijYBzE5nK/1qduvai.1noi',NULL,1,0,'GDViaymgWL','2024-05-06 09:36:25','2024-05-06 09:36:25'),(43,'mawulolo.yebovi','mawulolo.yebovi@cofinacorp.com','Ayi Mawulolo YEBOVI','ca','2024-05-06 09:36:25','$2y$12$UvzzRA6ICEaDjR/eIfWHcOHnkzx.YXTRNLo0Ztd/J4eHOSbU0wUHK',NULL,1,0,'dND6yccGYJ','2024-05-06 09:36:25','2024-05-06 09:36:25'),(44,'marcel.digbe','marcel.digbe@cofinacorp.com','Marcel DIGBE','md','2024-05-06 09:36:25','$2y$12$vKRoWeDPG.Ck1DCPy8rlVuBZTya.qWbhrK8LnNQQWKV4RuEJOPy4i',NULL,1,0,'j0JBXgBFky','2024-05-06 09:36:26','2024-05-06 09:36:26');
...
CREATE TABLE `verbals_trials` (
  ...
  `purpose_of_financing` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_of_credit_id` bigint unsigned NOT NULL,
  `amount` decimal(21,2) NOT NULL,
  `duration` int NOT NULL,
  `periodicity` enum('mensual','quarterly','semi-annual','annual','in-fine') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `verbals_trials` VALUES (1,'CFNTG-046-17-04-24-00201','2024-05-05','Mr','APEDO KOMLAN','MONDJRO','251040810001','Vente de graviers et sables','Renforcer son stock',33,2000000.00,12,'mensual',10.00,184027.00,2.79,1.00,17.00,12,2,'validated',NULL,'2024-05-07 17:38:56','2024-05-13 07:48:56'),(2,'CFNTG-044-15-04-24-00706','2024-05-05','Mr','ETS','ASSIODEI','254049708001','Produits alimentaires','S\'approvisionner en produits alimentaires',33,8000000.00,12,'mensual',10.00,736108.00,2.60,10.00,17.00,38,2,'waiting',NULL,'2024-05-07 17:50:25','2024-05-07 18:00:40'),(3,'CFNTG-044-16-04-24-00807','2024-05-06','Mr','KOFFI','KPOTUFE','251050581001','Quincaillerie','S\'approvisionner en articles de quincaillerie',28,4000000.00,18,'mensual',10.00,256560.00,2.50,1.00,17.00,10,2,'validated',NULL,'2024-05-07 18:09:12','2024-05-08 12:06:34'),(4,'-CFNTG-046-24-04-24-00503','2024-05-05','Mme','SARL U','VICKY ORISAKWE','251040182001','Commerce de vêtements','S\'approvisionner en habit femme',28,10000000.00,18,'mensual',10.00,641400.00,2.79,1.00,17.00,14,2,'validated',NULL,'2024-05-07 18:15:28','2024-05-13 15:00:34'),(5,'CFNTG-044-18-04-24-00504','2024-05-05','Mme','ENTREPRISE INDIVIDUELLE','ETS MALIVIA','251040555001','REVENDEUSE','Acheter de nouvelles gammes de pagnes',28,5000000.00,18,'mensual',10.00,320700.00,2.40,1.00,17.00,14,2,'validated',NULL,'2024-05-07 18:53:36','2024-05-08 12:07:56'),(6,'CFNTG-045-22-04-24-00101','2024-05-06','Mme','DJIGBODI ABRA','OKOUMA','251043664001','Revendeuse','Achat de céréales (maïs et haricot)',28,7500000.00,18,'mensual',10.00,481050.00,2.80,54620.00,17.00,26,2,'waiting',NULL,'2024-05-08 17:07:10','2024-05-08 17:14:34'),(7,'CFNTG-044-22-04-24-00301','2024-05-06','Mr','OUMAR','BARRY','251051308001','Commerce des accessoires et pièces de portables','financement de stocks',33,30000000.00,12,'mensual',10.00,2760404.00,2.79,150000.00,17.00,25,3,'validated',NULL,'2024-05-10 09:31:12','2024-05-10 09:57:16'),(8,'CFNTG-045-27-04-24-00202','2024-05-12','Mr','ETS AFRICA MODERNE ET FRERES','ENTREPRISE INDIVIDUELLE','251042525001','Vente d\'articles de quincaillerie','S\'approvisionner en articles de quincaillerie',28,10000000.00,18,'mensual',10.00,641400.00,2.70,1.00,17.00,11,2,'waiting',NULL,'2024-05-13 09:38:33','2024-05-13 09:38:33'),(9,'CFNTG-044-25-03-24-01608','2024-05-12','Mme','WODOME','Massan','251049760001','Revendeuse de pagnes','Achat de pagnes',28,5000000.00,18,'mensual',10.00,320700.00,2.79,1.00,17.00,19,2,'validated',NULL,'2024-05-13 17:10:15','2024-05-14 08:09:56');
...
-- Dump completed on 2024-05-16  8:05:08
